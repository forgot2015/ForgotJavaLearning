...
//    }
    ...
    public static String encryptHmacSHA1ToString(String data, String key) {
        return encryptHmacSHA1ToString(data.getBytes(Charset.forName("UTF-8")), key.getBytes(Charset.forName("UTF-8")));
    }
    ...
    public static String encryptHmacSHA224ToString(String data, String key) {
        return encryptHmacSHA224ToString(data.getBytes(Charset.forName("UTF-8")), key.getBytes(Charset.forName("UTF-8")));
    }
    ...
    public static String encryptHmacSHA256ToString(String data, String key) {
        return encryptHmacSHA256ToString(data.getBytes(Charset.forName("UTF-8")), key.getBytes(Charset.forName("UTF-8")));
    }
    ...
    public static String encryptHmacSHA384ToString(String data, String key) {
        return encryptHmacSHA384ToString(data.getBytes(Charset.forName("UTF-8")), key.getBytes(Charset.forName("UTF-8")));
    }
    ...
    public static String encryptHmacSHA512ToString(String data, String key) {
        return encryptHmacSHA512ToString(data.getBytes(Charset.forName("UTF-8")), key.getBytes(Charset.forName("UTF-8")));
    }
